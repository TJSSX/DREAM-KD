...
class TextClassificationDataset(Dataset):
    """Text classification dataset for CSV files with text,label columns."""
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train a student-only baseline for DREAM-KD.")
...
def main():
    ...
    safe_model_name = get_safe_model_name(args.student_model)
    output_dir = (
        PROJECT_ROOT
        / args.output_root
        / args.dataset
    ...
    print("=" * 80)
    print("Training student-only baseline")
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if dev_metrics["macro_f1"] > best_dev_macro_f1:
            ...
            print(f"New best student found at epoch {epoch}. Saving...")
    ...
    print("=" * 80)
    print("Loading best student for final test evaluation")
    print("=" * 80)
    ...
    print("=" * 80)
    print("Final student-only test results")
    print("=" * 80)
    print(final_results)
